...
public class MainActivity extends Activity {
    ...
    private MyAdapter myAdapter;//Adapter是用来帮助填充数据的中间桥梁，简单点说就是：将各种数据以合适的形式显示到view上,提供 给用户看！
    public ClientThread rxListenerThread;
    public static Handler mainHandler;
    private String[] scensString = new String[]
            {
                    "主客厅", "次客厅", "主卧", "次卧", "书房", "餐厅", "浴室", "阳台",
                    "花园"
            };
...
//        mImgicon = (ImageView) findViewById(R.id.titleImgSiftIcon);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                if (nodeinfo.getType() == 0x17 || nodeinfo.getType() == 0x08) {

                    Intent intent = new Intent();
                    if (nodeinfo.getType() == 0x08) {
                        ControlInterface.currentUiName = "马达";
                    } else {
                        ControlInterface.currentUiName = "I/O控制";
                    }
                    intent.setClass(MainActivity.this, ControlInterface.class);
...
//arg3是b在listview Y里的第几行的位置（很明显是第2行），大部分时候position和id的值是一样的，
...
//    }
    ...
    public void onBackPressed() {
        ...
        //	super.onBackPressed();
        new AlertDialog.Builder(MainActivity.this).setTitle("退出确定").setMessage("是否现在退出？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
