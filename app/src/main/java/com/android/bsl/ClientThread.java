    ...
    void connect() {
        ...
        try {
            ...
            if (socket.isConnected()) {
                ...
                rxThread.start();
                MainActivity.mainHandler.sendEmptyMessage(0X5555);
            } else {
                MainActivity.mainHandler.sendEmptyMessage(0X5556);
            }
            ...
            while (key) {
                ...
                try {
                    ...
                    if (readSize > 0) {
                        ...
                        MainActivity.mainHandler.sendEmptyMessage(0x1111);
                        // Log.d("Message:", str);
    ...
    public void addANode(NodeInfo node) {
        ...
        if (node.getType() == 0x17) {
            ...
            if (ControlInterface.handler != null
                    && ControlInterface.currentUiName.equals("I/O控制")) {
        ...
        if (node.getType() == 0x08) {
            ...
            msg.obj = node;
            if (ControlInterface.handler != null
                    && ControlInterface.currentUiName.equals("马达"))
                ControlInterface.handler.sendMessage(msg);
